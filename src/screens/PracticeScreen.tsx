// Écran de pratique - Modes d'entraînement
...
import { RootStackParamList, QuizMode } from '../types';

type PracticeScreenNavigationProp = StackNavigationProp<RootStackParamList>;
