// Écrans de base pour Audio et Profile
...
type AudioScreenNavigationProp = StackNavigationProp<RootStackParamList>;
            ...
            <Card key={audio.id} style={styles.audioCard}>
              ...
              <View style={styles.audioActions}>
                <Button
                  ...
                  icon="play-outline"
                  size="small"
                  onPress={() => navigation.navigate('AudioPlayer', { audioId: audio.id })}
                />
                <Button
                  title="Télécharger"
                  variant="outline"
